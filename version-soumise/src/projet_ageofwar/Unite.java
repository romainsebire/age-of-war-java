...
public class Unite extends JPanel {
    ...
    /**
     * Constructeur d'unité avec les statistiques du fichier XML
     * @param epoque
     * @param unite
     * @param donnees
     * @param affichage
    ...
    /**
     * Renvoie true si l'unité en question est morte
     * @return 
     */
    ...
    /**
     * Retire les points de vie "dégats" à l'unité
     * @param degats 
     */
    ...
    /**
     * Fait avancer l'unité d'un pixel
     */
    public void avancer(){
        this.positionX += 1;
    ...
    /**
     * Fait attaquer l'unité placée en paramètre
     * @param unite 
     */
    ...
    /**
     * Fait attaquer la base placée en paramètre
     * @param base 
     */
    ...
    /**
     * Affiche les dégats lorsque l'unité attaque
     */
    ...
    //METHODES GRAPHIQUES
    /**
     * Méthode graphique pour peindre l'image de l'objet
     * @param g 
     */
    @Override
    ...
    /**
     * Méthode graphique pour associer une image à l'objet
     * @param g 
     */
