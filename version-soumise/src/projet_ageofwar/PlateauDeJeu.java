...
public class PlateauDeJeu extends JFrame implements ActionListener {
    ...
    /**
     * Méthode pour créer une base au joueur à partir de son époque et des données mises en paramètres (vie et argent)
     * @param infos 
     */
    ...
    /**
     * Méthode pour créer une base à l'adversaire à partir de son époque et des données mises en paramètres (vie et argent)
     * @param infos 
     */
    ...
    /**
     * Méthode pour supprimer la base du joueur et pour récuperer ses informations (vie et argent)
     * @return 
     */
    ...
    /**
     * Méthode pour supprimer la base adversaire et pour récuperer ses informations (vie et argent)
     * @return 
     */
    ...
    /**
     * Méthode d'écoute des boutons pour agir en fonction du bouton enclenché
     * @param e 
     */
    @Override
    ...
    /**
     * Méthode pour faire attaquer toutes les unités du plateau une fois, en commencant par les adversaires
     */
    ...
    /**
     * Méthode pour faire avancer toutes les unités du plateau une fois, en commencant par les adversaires
     */
    ...
    // Actions de l'ennemi 
    /**
     * Méthode de tirage au sort pour envoyer une unité ennemie selon une certaine probabilité
     */
    ...
    /**
     * Méthode pour regarder si le jeu est fini et potentiellement déclencher l'écran de fin
     */
    public void jeuFini(){
    ...
    /**
     * Méthode pour créer une unité en fonction du numéro d'unité indiqué par le bouton qui a été pressé
     * @param numUnite 
     */
    ...
    /**
     * Méthode pour couper tous les timers
     */
